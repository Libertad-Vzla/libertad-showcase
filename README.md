...
- Registro público, actualizable y auditable de personas detenidas por motivos políticos: nombre, estado legal, lugar y fecha cuando se conocen, y observaciones.
- Búsqueda por nombre o cédula y filtros por estado. La cédula de adultos es pública; la de menores se enmascara según la ley.
...
- Un panel para el equipo: publicar y editar notas, revisar y agrupar reportes, llevar Memoria Viva, moderar comentarios y aportes, revisar el aprendizaje y administrar las fuentes de noticias.
- Cada acción importante queda en un registro de auditoría: quién, qué y cuándo.

## Privacidad

La identidad de quien reporta se guarda separada del contenido y no se publica. Las fotos se suben sin datos de ubicación. La cédula de adultos es pública en Memoria Viva; la de menores se enmascara. No hay rankings ni listas públicas de actividad. Guardamos la menor cantidad posible de datos.
